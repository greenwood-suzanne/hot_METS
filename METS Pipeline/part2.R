#Pipeline Part II: filters reads, takes filtered reads, finds the unique sequences, merges paired end reads, assigns taxonomy, 
#and creates taxonomy table plots. 
